...
- Create Angular project with ng: `ng new equipmentmanagementwebapp.client --defaults --skip-install --skip-git --no-standalone `.
...
- Create project file (`equipmentmanagementwebapp.client.esproj`).
